...
export default {
  ...
  actions: {
    async login({ commit }, data) {
      ...
      setToken('eyJhbGciOiJIUzI1NiJ9.eyJ1aWQiOiIxMDAwNjc5OCIsImV4cCI6MTYxNTcyMzkxNiwic3ViIjoiMTAwMDY3OTgiLCJwd2QiOiIzMjI5OTcyNmFiNmRiODY1OTNiNDU3YmFlZmVmN2MyMiIsImp0aSI6Ijk4N2VmY2E0LWZjZDUtNGNmMy05YzgwLTVkZGZmYTM2N2ZlZCIsImlhdCI6MTYxNDI1MjY4N30.wT49x2iCOnfR-q5hLt2Y_qAU6Hsj1U_SxiPbkc6krLY');
    },
    async info({ commit }) {
